...
<body class="bg-[url(https://lumeninc.org/wp-content/uploads/2024/09/indoor-wedding-decoration-ideas_.jpg)] bg-cover bg-center">
...
const allCategoriesButton = document.getElementById('all-categories-button');
  ...
  <div class="flex items-center justify-center min-h-screen bg-gray-100 bg-opacity-30">
    <div class="bg-white shadow-lg rounded-lg flex flex-col md:flex-row max-w-4xl w-full">
      <!-- Left Image Section -->
      <div class="w-full md:w-1/2 relative">
        <img
          src="https://images.unsplash.com/photo-1584923036455-6ff17dca0d71?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3wzMzczODV8MHwxfHJhbmRvbXx8fHx8fHx8fDE2OTQ1OTI1MDh8&ixlib=rb-4.0.3&q=80&w=1080"
          alt="couple"
          class="h-full w-full object-cover rounded-t-lg md:rounded-l-lg md:rounded-tr-none"
        />
