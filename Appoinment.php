...
<div class="max-w-4xl mx-auto px-6 py-12">
  <!-- Header -->
  <h2 class="text-3xl font-bold text-yellow-600 text-center mb-8">Make An Appoinment</h2>

  <form action="/register" method="POST" class="space-y-6 bg-white shadow-xl rounded-lg p-8">
    <!-- First Name -->
    <div>
      <label for="first_name" class="block text-sm font-medium text-yellow-600">First Name</label>
      <input type="text" id="first_name" name="first_name" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-yellow-600 focus:border-yellow-600 sm:text-sm" placeholder="First Name" required>
    </div>

    <!-- Last Name -->
    <div>
      <label for="last_name" class="block text-sm font-medium text-yellow-600">Last Name</label>
      <input type="text" id="last_name" name="last_name" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-yellow-600 focus:border-yellow-600 sm:text-sm" placeholder="Last Name" required>
    </div>

    <!-- Email -->
    <div>
      <label for="email" class="block text-sm font-medium text-yellow-600">Email Address</label>
      <input type="email" id="email" name="email" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-yellow-600 focus:border-yellow-600 sm:text-sm" placeholder="Email Address" required>
    </div>

    <!-- Mobile Number -->
    <div>
      <label for="mobile_number" class="block text-sm font-medium text-yellow-600">Mobile Number</label>
      <input type="tel" id="mobile_number" name="mobile_number" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-yellow-600 focus:border-yellow-600 sm:text-sm" placeholder="Mobile Number" required>
    </div>

    <!-- Address -->
    <div>
      <label for="address" class="block text-sm font-medium text-yellow-600">Address</label>
      <input type="text" id="address" name="address" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-yellow-600 focus:border-yellow-600 sm:text-sm" placeholder="Your Address" required>
    </div>

    <div>
      <label for="address" class="block text-sm font-medium text-yellow-600">Date</label>
      <input type="text" id="date" name="date" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-yellow-600 focus:border-yellow-600 sm:text-sm" placeholder="Your Address" required>
    </div>

    <div>
      <label for="address" class="block text-sm font-medium text-yellow-600">Time</label>
      <input type="text" id="time" name="time" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-yellow-600 focus:border-yellow-600 sm:text-sm" placeholder="Your Address" required>
    </div>


    <!-- Send Button (Initially Hidden) -->
    <div >
      <button type="submit" class="bg-yellow-600 text-white px-6 py-3 rounded-lg hover:bg-yellow-600 transition">
        Send
      </button>
    </div>
  </form>
